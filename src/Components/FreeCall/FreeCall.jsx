    ...
    return (
        <div className='schedule-call-main-div'>
            <div className="schedule-call-content-div">
                ...
                <p className='schedule-call-para-1'>You will have a clear knowledge of the next steps you need to take for your company to start producing reliable results online using funnels and paid advertising at the end of this audit call.</p>
                <p className='schedule-call-para-2'>To book your call, check for a slot on our Chief Marketing Officer's calendar right now. We hope to chat with you soon.</p>
